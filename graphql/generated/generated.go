...
`, BuiltIn: false},
	{Name: "../../schema/types/todo.graphql", Input: `type Todo @goModel(model: "github.com/elisalimli/meetmeup/graphql/models.Todo") {
    id: Int!
    name: String!
...
type FieldError{
	...
	{Name: "../../schema/types/user.graphql", Input: `type User @goModel(model: "github.com/elisalimli/meetmeup/graphql/models.User") {
    id: Int!
    email: String!
...
input UserInput @goModel(model: "github.com/elisalimli/meetmeup/graphql/models.UserInput") {
    email: String!
    firstName: String!
    lastName: String!
}
